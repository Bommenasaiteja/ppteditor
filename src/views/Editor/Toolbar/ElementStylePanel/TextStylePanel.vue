<template>
  <div class="text-style-panel">
    ...
    <div style="padding-bottom: 8px;">
      <div style="padding-bottom: 8px;"><b>Line spacing:</b></div>
      <Select
        :value="lineHeight || 1"
    ...
    <div style="padding-bottom: 8px;">
      <div style="padding-bottom: 8px;"><b>Paragraph spacing:</b></div>
      <Select
    ...
    <div style="padding-bottom: 8px;">
      <div style="padding-bottom: 8px;"><b>Word spacing:</b></div>
      <Select
        :value="wordSpace || 0"
    ...
    <div style="padding-bottom: 8px;">
      <div style="padding-bottom: 8px;"><b>Text filling:</b></div>
