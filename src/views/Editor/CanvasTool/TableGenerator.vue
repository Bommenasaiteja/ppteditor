...
const insertCustomTable = () => {
  if (customRow.value < 1 || customRow.value > 20) return message.warning('Number of rows/columns must be between 0 and 20! ')
  if (customCol.value < 1 || customCol.value > 20) return message.warning('Number of rows/columns must be between 0 and 20! ')
